...
class AddMarkerPage extends StatefulWidget {
  ...
  AddMarkerPage({String id, String icon})
      : _id = id,
        _icon = icon;
        ...
        child: new Column(
          ...
          children: <Widget>[
            new Container(
              ...
              child: new Center(
                child: Icon(
                  MdiIcons.fromString(icon ?? "flagPlus"),
              ...
              decoration: new BoxDecoration(
                ...
                border: new Border.all(
                    width: 1.0, color: Color.fromRGBO(114, 103, 239, 1)),
                borderRadius:
          ...
          child: Column(
            children: <Widget>[
              ...
              new TextFormField(
                ...
                validator: (value) {
                  if (value.isEmpty)
                    return 'Дайте название своему маркеру';
                  else {
                ...
                onPressed: () {
                  if (_formKey.currentState.validate()) {
                    if (_name != null) {
                      ...
                      Marker mark = new Marker(name: _name, icon: icon);
