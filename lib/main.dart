      ...
      onGenerateRoute: (RouteSettings) {
        ...
        if (path[1] == 'postPage') {
          return new MaterialPageRoute(
              builder: (context) => new PostPage(id: path[2]),
        ...
        if (path[1] == 'addMark') {
          return new MaterialPageRoute(
              builder: (context) =>
                  new AddMarkerPage(id: path[2], icon: path[3]),
              settings: RouteSettings);
        }
                              ...
                              return RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    ...
                                    TextSpan(
                                        text:
                                            'Всего задач: ${snapshot.data.toString()}',
                                        style: TextStyle(
                                          fontSize: 22.0,
                                          fontFamily: 'Exo 2',
                              ...
                              DBProvider.db
                                ...
                                check().then((intenet) {
                                  ...
                                  if (intenet != null &&
                                      intenet &&
                                      registration) {
                                    print("synchromised And Pr --->" +
                                        pr.toString() +
                                        "Id user Server --->" +
                                        userIdServer.toString());
                                    httpGet(
                                        "https://delau.000webhostapp.com/flutter/delete.php?id=" +
                                            item.id.toString() +
                                            "&priority=" +
                                            (pr ~/ 2).toString() +
                                            "&user_id=" +
